...
// Создание только главной страницы
export const seedHomePageOnly = async (payload: Payload): Promise<void> => {
  console.log('🏠 Creating home page only...')
  ...
  try {
    ...
    if (!form) {
      console.error('Form "Заявка на консультацию" not found!')
      return
    }
    ...
    console.log(`   - Blocks: ${homePage.layout?.length || 0}`)
  } catch (error) {
